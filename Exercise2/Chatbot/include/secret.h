#ifndef SECRET
const char ssid[] = "H369A432F1F"; // Vul hier je Wi-Fi ssid in (niet belangrijk voor oplevering)
const char pass[] = "3D6269C97CEA"; // Vul hier je Wi-Fi wachtwoord in (niet belangrijk voor oplevering)

const char *MQTT_HOST = "netwerkenbasis.com";
const int MQTT_PORT = 8883; // Voer hier de MQTT-broker poort in op de aangegeven plek
const char *MQTT_CLIENT_ID = "BOT-1030808"; // Voer hier je leerlingnummer in op de aangegeven plek
